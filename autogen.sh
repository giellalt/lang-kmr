...
function print_usage() {
    ...
    echo "  -l, --add-langvar   Add env. variable \$GTLANG_kmr to login script."
...
# the current dir:
if   test x${GTLANG_kmr} = x ; then
	echo "WARNING: The variable \${GTLANG_kmr} has not been defined. You"
	...
	echo "$0 -l"
	echo
elif test x${GTLANG_kmr} != x${LANGDIR} ; then
	echo "WARNING: The variable \${GTLANG_kmr} has the value:"
	echo "  ${GTLANG_kmr}"
