...
This directory contains source files for the Northern Kurdish language
...
-   <https://giellalt.uit.no/lang/kmr/index.html> (analyser)
...
The Northern Kurdish language sources can be acquired using [giella SVN
